...
class UranusStep extends StatelessWidget {
  const UranusStep({Key? key}) : super(key: key);
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                gradient: LinearGradient(
                  ...
                  colors: [Colors.white, Color(0xFF188CA6)],
                  stops: <double>[0, 1],
                ),
              ),
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text.rich(
                        //제목 text (2단계 :천왕성에서의 기록)
                        TextSpan(
                          children: [
                            TextSpan(
                              text: '2단계 : \n',
                              style: TextStyle(
                                color: const Color(0xFF027CA2),
                                fontSize: 27.sp,
                      ...
                      SizedBox(
                        ...
                        height: 120.h,
                        child: Image.asset(
                          'assets/page-1/images/uranus.png',
                        ),
                      )
                    ],
                  ),
